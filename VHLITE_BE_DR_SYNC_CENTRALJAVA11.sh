...
OCI_DES_LIBS_PATH=/usr/local/tbx/centraljava11/apache-tomcat-9.0.36/lib/ext
OCI_DES_SERVICES_PATH=/usr/local/tbx/centraljava11/apache-tomcat-9.0.36/webapps


OCI_DES_APP_SERVER_IP=10.168.3.57
OCI_DES_APP_USER=centraljava11


#SOURCE_SCHEDULER_PATH=/usr/local/tbx/vhtcbestg/Scheduler_Resources
SOURCE_LIBS_PATH=/usr/local/tbx/centraljava11/apache-tomcat-9.0.36/lib/ext
SOURCE_SERVICES_PATH=/usr/local/tbx/centraljava11/apache-tomcat-9.0.36/webapps


CURRENT_TIME=`date "+%Y-%m-%d_%H.%M.%S"`
CURRENT_DATE=`date +"%Y_%m_%d"`

LOG_FILE_LOCATION=/home/centraljava11/dr_sync
SOURCE_MD5SUM_FILE_LOCATION=/home/centraljava11/dr_sync
OCI_DES_MD5SUM_FILE_LOCATION=/home/centraljava11/dr_sync
...
log_dir="/home/centraljava11/dr_sync"
days=10
