...
OCI_DES_SERVICES_PATH=/usr/local/tbx/central/apache-tomcat-9.0.26.0/webapps
...
SOURCE_LIBS_PATH=/usr/local/tbx/central/apache-tomcat-9.0.26.0/lib
SOURCE_SERVICES_PATH=/usr/local/tbx/central/apache-tomcat-9.0.26.0/webapps
...
echo "Getting md5sum values from dr server ( 10.168.4.182 ).............."
...
echo "Getting md5sum values from LOCAL server ( 192.168.4.182 ).............."
