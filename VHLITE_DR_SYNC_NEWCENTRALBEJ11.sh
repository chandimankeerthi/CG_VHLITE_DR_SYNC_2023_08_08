...
OCI_DES_LIBS_PATH=/usr/local/tbx/newcentralbej11/apache-tomcat-9.0.36/lib/ext
OCI_DES_SERVICES_PATH=/usr/local/tbx/newcentralbej11/apache-tomcat-9.0.36/webapps


OCI_DES_APP_SERVER_IP=10.168.4.182
OCI_DES_APP_USER=newcentralbej11



SOURCE_LIBS_PATH=/usr/local/tbx/newcentralbej11/apache-tomcat-9.0.36/lib/ext
SOURCE_SERVICES_PATH=/usr/local/tbx/newcentralbej11/apache-tomcat-9.0.36/webapps


CURRENT_TIME=`date "+%Y-%m-%d_%H.%M.%S"`
CURRENT_DATE=`date +"%Y_%m_%d"`

LOG_FILE_LOCATION=/home/newcentralbej11/dr_sync
SOURCE_MD5SUM_FILE_LOCATION=/home/newcentralbej11/dr_sync
OCI_DES_MD5SUM_FILE_LOCATION=/home/newcentralbej11/dr_sync
...
STATUS_FILE=$LOG_FILE_LOCATION/STATUS_FE.log

##### mail details ###

subject="DO NOT REPLY: VHTC FE DR SYNC $CURRENT_TIME "
...
echo "Getting md5sum values from dr server ( 10.168.3.41 ).............."
...
echo "Getting md5sum values from LOCAL server ( 192.168.3.41 ).............."
...
log_dir="/home/newcentralbej11/dr_sync"
days=10
